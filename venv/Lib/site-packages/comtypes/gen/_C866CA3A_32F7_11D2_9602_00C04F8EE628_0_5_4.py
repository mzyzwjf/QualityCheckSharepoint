# -*- coding: mbcs -*-
typelib_path = u'C:\\Windows\\System32\\Speech\\Common\\sapi.dll'
...
class ISpeechRecoResultDispatch(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    _case_insensitive_ = True
    u'ISpeechRecoResultDispatch Interface'
...
ISpeechRecoResultDispatch._methods_ = [
    ...
    COMMETHOD([dispid(10), helpstring(u'GetXMLResult')], HRESULT, 'GetXMLResult',
              ( ['in'], SPXMLRESULTOPTIONS, 'Options' ),
              ( ['retval', 'out'], POINTER(BSTR), 'pResult' )),
    COMMETHOD([dispid(11), helpstring(u'GetXMLErrorInfo')], HRESULT, 'GetXMLErrorInfo',
    ...
    COMMETHOD([dispid(12), helpstring(u'SetTextFeedback')], HRESULT, 'SetTextFeedback',
              ( ['in'], BSTR, 'Feedback' ),
...
class ISpPhoneticAlphabetConverter(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    _case_insensitive_ = True
    u'ISpPhoneticAlphabetConverter Interface'
...
class IInternetSecurityMgrSite(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    _case_insensitive_ = True
    u'IInternetSecurityMgrSite Interface'
...
class IInternetSecurityManager(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    _case_insensitive_ = True
    u'IInternetSecurityManager Interface'
...
class ISpPhoneticAlphabetSelection(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    _case_insensitive_ = True
    u'ISpPhoneticAlphabetSelection Interface'
...
class ISpeechResourceLoader(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    _case_insensitive_ = True
    u'ISpeechResourceLoader Interface'
...
class SpPhoneticAlphabetConverter(CoClass):
    u'SpPhoneticAlphabetConverter Class'
...
class ISpeechXMLRecoResult(ISpeechRecoResult):
    _case_insensitive_ = True
    u'ISpeechXMLRecoResult Interface'
...
class ISpeechRecoResult2(ISpeechRecoResult):
    _case_insensitive_ = True
    u'ISpeechRecoResult2 Interface'
    _iid_ = GUID('{8E0A246D-D3C8-45DE-8657-04290C458C3C}')
    _idlflags_ = ['dual', 'oleautomation']
ISpeechRecoResult2._methods_ = [
    COMMETHOD([dispid(12), helpstring(u'DiscardResultInfo')], HRESULT, 'SetTextFeedback',
              ( ['in'], BSTR, 'Feedback' ),
              ( ['in'], VARIANT_BOOL, 'WasSuccessful' )),
]
################################################################
...
__all__ = [ 'SVSFPersistXML', 'DISPID_SBSWrite', 'SSSPTRelativeToEnd',
           ...
           'SVEVoiceChange', 'SECFIgnoreKanaType',
           'DISPID_SPILanguageId', 'SPPS_Function',
           'DISPID_SRSCurrentStreamNumber', 'SPXMLRESULTOPTIONS',
           'DISPID_SRRSpeakAudio', 'DISPID_SRState',
           'DISPID_SpeechPhraseElement', 'SECFIgnoreCase',
           'SPRST_INACTIVE', 'SPLO_DYNAMIC', 'SP_VISEME_0',
           'SAFTCCITT_uLaw_11kHzMono', 'ISpeechGrammarRule',
           'DISPID_SDKEnumValues', 'SAFTADPCM_11kHzStereo',
           'SPEI_INTERFERENCE', 'ISpeechVoice', 'SVSFParseMask',
           'ISpeechRecoResult', 'SPWT_LEXICAL', 'DISPID_SDKCreateKey',
           'DISPID_SRCEBookmark', '_RemotableHandle', 'IEnumString',
           'DISPID_SASState', 'DISPID_SRCVoice', 'SPEI_SR_PRIVATE',
           'SpeechStreamSeekPositionType', 'Speech_Max_Word_Length',
           'DISPID_SRRRecoContext', 'SAFTCCITT_uLaw_44kHzStereo',
           'ISpeechLexiconPronunciations', 'SPWORD',
           'DISPID_SPPs_NewEnum', 'DISPID_SRCEFalseRecognition',
           'SPGRAMMARWORDTYPE', 'SAFT8kHz16BitStereo',
           'DISPID_SOTGetAttribute', 'SPAR_Low',
           'ISpeechWaveFormatEx', 'DISPID_SRGReset',
           'STCInprocHandler', 'DISPID_SWFESamplesPerSec',
           'SAFTCCITT_uLaw_44kHzMono', 'SPCT_DICTATION',
           'DISPID_SRIsUISupported', 'SpeechAudioState',
           'DISPID_SVResume', 'SPCT_SUB_COMMAND', 'ISpRecoResult',
           'SASRun', 'SpeechFormatType', 'DISPID_SpeechLexiconProns',
           'SPBO_AHEAD', 'SPEI_SR_BOOKMARK', 'SPPS_Interjection',
           'DISPID_SPELexicalForm', 'SAFTADPCM_22kHzMono', 'SFTInput',
           'DISPID_SVESentenceBoundary', 'ISpeechObjectTokens',
           'SPRECOCONTEXTSTATUS',
           'DISPID_SpeechGrammarRuleStateTransitions',
           'SPSHORTCUTPAIRLIST', 'SREBookmark',
           'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
           'Speech_Default_Weight', 'SPSUnknown', 'SFTSREngine',
           'DISPID_SOTRemove', 'SVF_Stressed', 'DISPID_SVRate',
           'DISPID_SGRSTNextState', 'SVEStartInputStream',
           'SpeechBookmarkOptions', 'DISPID_SPIReplacements',
           'DISPID_SLPs_NewEnum', 'DISPID_SGRSTText',
           'DISPID_SRCRequestedUIType', 'SPSNotOverriden',
           'DISPID_SPRFirstElement', 'SPEI_VISEME',
           'DISPID_SLWLangId', 'SpeechGrammarTagDictation',
           'SpNullPhoneConverter', 'SPEI_START_INPUT_STREAM',
           'DISPID_SpeechBaseStream', 'SPSHT_NotOverriden',
           'ISpStreamFormatConverter', 'DISPID_SGRsCount', 'SVP_20',
           'SVP_21', 'SAFT12kHz16BitMono', 'DISPID_SAStatus',
           'SDKLLocalMachine', 'DISPID_SRCERequestUI',
           'SAFT24kHz16BitMono', 'IEnumSpObjectTokens',
           'SRTAutopause', 'DISPID_SPEDisplayText', 'SITooSlow',
           'SRAONone', 'eLEXTYPE_LETTERTOSOUND',
           'DISPID_SpeechGrammarRuleState', 'SREStreamEnd',
           'SpeechMicTraining', 'DISPID_SPIEnginePrivateData',
           'DISPID_SVPriority', 'SPLEXICONTYPE', 'SpeechRuleState',
           'ISpPhoneticAlphabetSelection',
           'SpeechPropertyAdaptationOn', 'SVSFParseSsml',
           'DISPID_SOTCSetId', 'DISPID_SGRSTs_NewEnum',
           'SpeechUserTraining', 'SASClosed',
           'ISpObjectTokenCategory', 'SDTProperty',
           'SRTExtendableParse', 'DISPID_SRRecognizer', 'SRSEDone',
           'ISpeechPhraseAlternate', 'eWORDTYPE_ADDED',
           'DISPID_SRRTLength', 'DISPID_SRSAudioStatus',
           'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SOTsItem',
           'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRsAdd',
           'SRTSMLTimeout', 'ISpeechRecoGrammar', 'SRTStandard',
           'SPBO_PAUSE', 'DISPID_SPERetainedSizeBytes',
           'SAFT22kHz8BitStereo', 'ISpeechLexiconPronunciation',
           'SPSModifier', 'DISPID_SPRuleId', 'SPSSuppressWord',
           'SPEI_REQUEST_UI', 'DISPID_SVSpeakStream',
           'DISPID_SPPConfidence', 'DISPID_SRStatus',
           'DISPID_SRGRecoContext', 'SAFT32kHz8BitStereo',
           'DISPID_SRGetRecognizers', 'DISPID_SRCEPhraseStart',
           'DISPID_SVEEnginePrivate', 'WAVEFORMATEX', 'SPVPRI_NORMAL',
           'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechXMLRecoResult',
           'DISPID_SGRs_NewEnum', 'SDTDisplayText',
           'SpeechAddRemoveWord', 'SPVPRIORITY', 'ISpRecoContext',
           'SVF_Emphasis', 'SWPKnownWordPronounceable',
           'DISPID_SRSClsidEngine', 'SDA_No_Trailing_Space',
           'SDTRule', 'DISPID_SPRulesItem', 'SPRST_NUM_STATES',
           'SP_VISEME_10', 'SPFM_OPEN_READONLY', 'ISpeechBaseStream',
           'DISPID_SRCRetainedAudioFormat',
           'DISPID_SLGetGenerationChange', 'DISPID_SRRTimes',
           'SpeechGrammarRuleStateTransitionType',
           'SpeechInterference', 'DISPID_SRRAlternates',
           'DISPID_SWFEBitsPerSample', 'DISPID_SVEAudioLevel',
           'DISPID_SVSkip', 'SpeechCategoryAppLexicons',
           'ISpeechPhraseAlternates', 'DISPID_SPEActualConfidence',
           'DISPID_SASetState', 'DISPID_SPRText', 'SREAudioLevel',
           'SPSHT_EMAIL', 'SpResourceManager',
           'DISPID_SABIMinNotification', 'DISPID_SPRules_NewEnum',
           'DISPID_SPPName', 'SREAllEvents', 'SDA_One_Trailing_Space',
           'SAFTNoAssignedFormat', 'DISPID_SGRSTPropertyName',
           'SpNotifyTranslator', 'ISpeechResourceLoader',
           'SDKLCurrentUser', 'SPPHRASEREPLACEMENT',
           'SSSPTRelativeToStart', 'DISPID_SDKSetBinaryValue',
           'DISPID_SpeechRecoResult', 'ISpGrammarBuilder',
           'ISpDataKey', 'DISPID_SLAddPronunciationByPhoneIds',
           'SVEPhoneme', 'DISPID_SpeechRecognizerStatus',
           ...
           'SPWF_INPUT', 'DISPID_SPPsItem', 'eLEXTYPE_RESERVED10',
           'SpeechRecoEvents', 'SPEI_VOICE_CHANGE',
           'DISPID_SpeechAudioBufferInfo', 'SAFT32kHz16BitMono',
           'SP_VISEME_17', 'SP_VISEME_16', 'SP_VISEME_15',
           'SP_VISEME_14', 'SP_VISEME_13', 'SP_VISEME_12',
           'SP_VISEME_11', 'SAFT8kHz8BitMono', 'SAFT16kHz16BitStereo',
           'DISPID_SpeechDataKey', 'SpLexicon',
           'DISPID_SLGenerationId', 'SPEI_MAX_SR',
           'SpInProcRecoContext', 'SP_VISEME_19', 'SP_VISEME_18',
           'SPPS_LMA', 'SpeechGrammarTagWildcard',
           'STSF_LocalAppData', '_ISpeechVoiceEvents',
           'SAFTTrueSpeech_8kHz1BitMono', 'SSTTTextBuffer',
           'SP_VISEME_3', 'SP_VISEME_2', 'SP_VISEME_1',
           'DISPID_SWFEExtraData', 'SP_VISEME_7', 'SPEI_TTS_PRIVATE',
           'DISPID_SPPChildren', 'SP_VISEME_4',
           'DISPID_SVSCurrentStreamNumber', 'SP_VISEME_9',
           'SPEI_SR_RETAINEDAUDIO', 'SpeechSpecialTransitionType',
           'DISPID_SVAudioOutput', 'DISPID_SAVolume',
           'ISpObjectToken', 'ISpResourceManager', 'SpeechTokenKeyUI',
           'SAFTADPCM_22kHzStereo', 'DISPID_SPERetainedStreamOffset',
           'DISPID_SGRsCommitAndSave', 'DISPID_SPPValue',
           'DISPID_SRCState', 'SPWT_DISPLAY',
           'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
           'DISPID_SpeechGrammarRules', 'SINoSignal', 'DISPID_SGRId',
           'DISPID_SPAPhraseInfo', 'DISPID_SVSRunningState',
           'SPRS_ACTIVE', 'SpeechCategoryPhoneConverters',
           'SpUnCompressedLexicon', 'eLEXTYPE_PRIVATE3',
           'eLEXTYPE_PRIVATE2', 'eLEXTYPE_PRIVATE5',
           'SpeechEngineProperties', 'eLEXTYPE_PRIVATE7',
           'eLEXTYPE_PRIVATE6', 'eLEXTYPE_PRIVATE9',
           'eLEXTYPE_PRIVATE8', 'DISPID_SRCCreateResultFromMemory',
           'DISPID_SVSLastBookmarkId',
           'DISPID_SpeechObjectTokenCategory', 'SPEI_PHRASE_START',
           'SITooFast', 'SpeechDisplayAttributes',
           'DISPID_SpeechPhraseBuilder', 'SpFileStream',
           'eLEXTYPE_PRIVATE20', 'SPCT_SUB_DICTATION',
           'DISPID_SLGetWords', 'SPSHT_Unknown', 'SLTUser',
           'SAFTGSM610_22kHzMono', 'DISPID_SPRNumberOfElements',
           'SpeechRegistryLocalMachineRoot',
           'DISPID_SRSSupportedLanguages', 'DISPID_SRGRules',
           'DISPID_SVSLastBookmark', 'ISpeechAudioStatus',
           'ISpEventSink', 'SAFTGSM610_44kHzMono',
           'SPDKL_DefaultLocation', 'DISPID_SPRuleEngineConfidence',
           'SPSMF_UPS', 'ISpMMSysAudio', 'SGRSTTWildcard',
           'DISPID_SVGetProfiles', 'SpeechVisemeType',
           'DISPID_SPEAudioTimeOffset', 'DISPID_SLPsItem',
           'SVEEndInputStream', 'SDA_Consume_Leading_Spaces',
           'SPCS_DISABLED', 'DISPID_SASCurrentSeekPosition',
           'ISpeechPhraseInfo', 'ISpPhrase', 'SREPhraseStart',
           'DISPID_SGRSTPropertyId',
           'DISPID_SpeechLexiconPronunciation', 'DISPID_SPRulesCount',
           'DISPID_SRCRetainedAudio', 'SPAS_RUN',
           'ISpeechGrammarRuleState', 'DISPID_SLWType',
           'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPRsCount',
           'SAFTGSM610_8kHzMono', 'DISPID_SAEventHandle', 'SPPHRASE',
           'SpeechVoiceCategoryTTSRate', 'DISPIDSPTSI',
           'SPGS_ENABLED', 'DISPID_SPAs_NewEnum',
           ...
           'SPEI_HYPOTHESIS', 'SPINTERFERENCE_LATENCY_WARNING',
           'ISpRecognizer2', 'SpeechVoicePriority',
           'SECFEmulateResult', 'DISPID_SpeechFileStream',
           'SVSFIsXML', 'DISPID_SOTs_NewEnum', 'DISPID_SVVoice',
           'LONG_PTR', 'SGPronounciation', 'SpeechTokenIdUserLexicon',
           'SREPropertyNumChange', 'DISPID_SVPause',
           'SPPHRASEELEMENT', 'DISPID_SLWsItem', 'ISpAudio',
           'DISPID_SRGCmdLoadFromResource',
           'DISPID_SpeechPhraseProperty', 'SPBO_NONE',
           'SpeechRecoContextState', 'DISPID_SVSpeak',
           'SpWaveFormatEx', 'SVEBookmark', 'SVSFNLPSpeakPunc',
           'ISpRecognizer', 'SSTTWildcard', 'SpShortcut',
           'SP_VISEME_6', 'DISPID_SWFEBlockAlign',
           'SECHighConfidence', 'DISPID_SpeechLexiconWord',
           'SVSFNLPMask', 'SpCustomStream', 'SPSHT_OTHER',
           'STCLocalServer', 'DISPIDSPTSI_ActiveLength',
           ...
           'SSSPTRelativeToCurrentPosition', 'SPSNoun',
           'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_ADAPTATION',
           'SGDSActiveUserDelimited',
           'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_8',
           'DISPID_SGRSTransitions', 'SPPS_NotOverriden',
           'SPSEMANTICFORMAT', 'SAFT12kHz8BitMono',
           'DISPID_SMSGetData', 'SAFT32kHz8BitMono',
           'DISPID_SPIAudioSizeBytes', 'SRCS_Disabled',
           'ISpEventSource', 'SAFT48kHz16BitMono',
           'SAFT11kHz16BitStereo', 'SPFILEMODE', 'ISequentialStream',
           'DISPID_SRCRecognizer', 'SAFTADPCM_44kHzMono',
           'DISPID_SRRTStreamTime', 'DISPID_SpeechPhraseReplacement',
           'DISPID_SPIRule', 'SAFT11kHz16BitMono',
           'SAFTCCITT_uLaw_22kHzMono', 'ISpeechPhraseInfoBuilder',
           'eWORDTYPE_DELETED', 'SpeechCategoryRecoProfiles',
           'SPAR_High', 'DISPID_SPEAudioSizeTime', 'SRESoundStart',
           'DISPID_SRRTOffsetFromStart', 'DISPID_SRGCommit',
           'ISpeechPhoneConverter', 'SPSERIALIZEDPHRASE', 'SAFTText',
           'SRAORetainAudio', 'SpSharedRecoContext',
           'SPWORDPRONOUNCEABLE', 'SASPause',
           'ISpeechPhraseReplacement', 'DISPID_SDKOpenKey',
           'SECFIgnoreWidth', 'DISPID_SPARecoResult', 'SRARoot',
           'ISpNotifySource', 'DISPID_SOTRemoveStorageFileName',
           'DISPID_SRGetFormat', 'IInternetSecurityManager',
           'DISPID_SpeechPhraseElements', 'DISPID_SRCEAdaptation',
           'SVSFUnusedFlags', 'SPEI_WORD_BOUNDARY', 'ISpStream',
           'SPEVENT', 'DISPID_SLRemovePronunciationByPhoneIds',
           'ISpeechLexiconWord', 'ISpeechVoiceStatus',
           'SDA_Two_Trailing_Spaces', 'DISPID_SVDisplayUI',
           'SECFDefault', 'SpInprocRecognizer', 'DISPID_SRCPause',
           'SPPS_Modifier', 'IInternetSecurityMgrSite',
           'DISPID_SABufferNotifySize', 'Speech_StreamPos_Asap',
           'DISPID_SRGDictationUnload', 'SREPropertyStringChange',
           'DISPID_SASCurrentDevicePosition',
           'SpeechCategoryAudioOut', 'SDTAll',
           'ISpeechPhraseProperties', 'DISPID_SPIStartTime',
           'SAFT11kHz8BitStereo', 'SAFTNonStandardFormat',
           'SPRST_ACTIVE', 'SpCompressedLexicon',
           ...
           'DISPID_SOTCategory', 'SLOStatic', 'DISPID_SVEPhoneme',
           'SLTApp', 'DISPID_SPANumberOfElementsInResult',
           'DISPID_SOTSetId', 'SPAS_STOP',
           'DISPID_SpeechPhraseAlternate', 'ISpXMLRecoResult',
           'DISPID_SBSSeek', 'DISPID_SOTCGetDataKey',
           'DISPID_SGRsFindRule', 'SPINTERFERENCE_TOOLOUD',
           'DISPID_SRAudioInput', 'DISPID_SpeechMMSysAudio',
           'DISPID_SLPSymbolic', 'SSTTDictation', 'ISpRecoGrammar',
           'SpeechVoiceSpeakFlags', 'tagSPPROPERTYINFO',
           'eLEXTYPE_PRIVATE1', 'SPEI_RESERVED2', 'SPEI_RESERVED3',
           'SPRS_INACTIVE', 'SPEI_RESERVED6', 'SRCS_Enabled',
           'SVPNormal', 'SAFTCCITT_ALaw_22kHzMono', 'SRESoundEnd',
           'SPFM_OPEN_READWRITE', 'DISPIDSPTSI_ActiveOffset',
           'SGSDisabled', 'DISPID_SDKDeleteValue', 'SPEI_PHONEME',
           'SpeechPropertyHighConfidenceThreshold', 'SPSLMA',
           'SREInterference', 'DISPID_SAFGetWaveFormatEx',
           'DISPID_SVGetAudioOutputs', 'SPEI_SOUND_START',
           ...
           'SPFM_CREATE_ALWAYS', 'ISpeechObjectToken',
           'DISPID_SRRGetXMLResult', 'DISPID_SRCEAudioLevel',
           'DISPID_SWFEFormatTag', 'DISPID_SLPPhoneIds', 'SRSActive',
           'DISPID_SPEs_NewEnum', 'DISPID_SABufferInfo',
           'DISPID_SpeechRecoResult2', 'SPPHRASEPROPERTY',
           'SP_VISEME_20', 'SPCONTEXTSTATE',
           'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechTokenShellFolder',
           'DISPID_SRProfile', 'DISPID_SGRAddState',
           'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SWFEChannels',
           'SVPOver', 'SREStateChange', 'DISPID_SGRInitialState',
           'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
           'DISPID_SABIBufferSize', 'DISPID_SRRSaveToMemory',
           'SRTEmulated', 'DISPID_SRSetPropertyString',
           'SRSEIsSpeaking', 'SpeechVisemeFeature',
           'DISPID_SRSCurrentStreamPosition', 'SAFT44kHz16BitMono',
           'SPPS_SuppressWord', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
           'tagSPTEXTSELECTIONINFO', 'SPFM_CREATE',
           ...
           'SpeechLoadOption', 'SPVPRI_OVER',
           'Speech_Max_Pron_Length', 'SRADynamic',
           'DISPID_SPPFirstElement', 'DISPID_SRDisplayUI',
           'SPFM_NUM_MODES', 'DISPID_SpeechAudioFormat',
           'SPEI_END_INPUT_STREAM', 'SPSTREAMFORMATTYPE',
           'SpMMAudioIn', 'SPPROPERTYINFO', 'DISPID_SPIAudioSizeTime',
           'ISpStreamFormat', 'DISPID_SASFreeBufferSpace',
           'DISPID_SRCAudioInInterferenceStatus', 'SREPrivate',
           'DISPID_SVEBookmark', 'SpMMAudioEnum',
           'SpeechGrammarState', 'DISPID_SOTCEnumerateTokens',
           'SASStop', 'SAFT16kHz8BitStereo', 'SRSInactiveWithPurge',
           'DISPID_SpeechVoiceEvent', 'DISPID_SRCEventInterests',
           'SPAO_NONE', 'DISPID_SOTGetStorageFileName',
           'ISpeechPhraseReplacements', 'SAFT11kHz8BitMono',
           'SpeechAudioProperties', 'DISPID_SRIsShared',
           'SPAUDIOSTATE', 'SVSFIsNotXML',
           'DISPID_SPRuleNumberOfElements', 'DISPID_SOTId',
           'SSFMCreateForWrite', 'SPINTERFERENCE_NOSIGNAL',
           'SpPhoneConverter', '_SPAUDIOSTATE', 'eLEXTYPE_APP',
           'DISPID_SLRemovePronunciation', 'DISPID_SVSVisemeId',
           'DISPID_SVSInputSentenceLength', 'DISPID_SVEventInterests',
           'SPEI_MAX_TTS', 'ISpeechAudioBufferInfo', 'ISpProperties',
           'ISpeechPhraseElement', 'IStream', 'SPEI_RESERVED1',
           ...
           'DISPID_SDKEnumKeys', 'DISPID_SRCSetAdaptationData',
           'DISPID_SLAddPronunciation', 'SpeechPropertyResourceUsage',
           'SAFT48kHz8BitMono', 'SGSExclusive', 'SpeechTokenKeyFiles',
           'SPDKL_CurrentUser', 'DISPID_SGRSTRule',
           'DISPID_SRCEPropertyNumberChange', 'DISPID_SVSLastResult',
           'DISPID_SPIGetDisplayAttributes',
           'SGLexicalNoSpecialChars', 'ISpeechRecoResult2',
           'SAFT24kHz8BitMono', 'SDTLexicalForm', 'SPXRO_SML',
           'DISPID_SGRName', 'SINone', 'SPEI_TTS_BOOKMARK',
           'SpTextSelectionInformation', 'SPLO_STATIC',
           'SpeechDiscardType', 'SpeechEngineConfidence',
           'DISPID_SRGIsPronounceable', 'ISpRecoCategory',
           'SSFMOpenForRead', 'DISPID_SPEAudioStreamOffset',
           'SVPAlert', 'SPRST_INACTIVE_WITH_PURGE',
           'DISPID_SMSADeviceId', 'DISPID_SGRClear',
           'DISPID_SGRSAddWordTransition',
           'DISPID_SREmulateRecognition', 'ISpeechLexiconWords',
           'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGCmdLoadFromMemory',
           'DISPID_SPRDisplayAttributes', 'ISpeechMemoryStream',
           'SPSHORTCUTTYPE', 'SPCT_SLEEP', 'SpeechAudioVolume',
           'DISPID_SVSInputSentencePosition',
           'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SpeechGrammarRule',
           'SPPS_Noncontent', 'SpeechLexiconType', 'SPRECOSTATE',
           'DISPID_SOTDisplayUI', 'SGRSTTTextBuffer',
           'DISPID_SLWs_NewEnum', 'SpeechCategoryVoices',
           'SPDATAKEYLOCATION', 'SRTReSent', 'SITooLoud', 'ISpVoice',
           'SRERecognition', 'STCRemoteServer', 'SpMemoryStream',
           'SWTDeleted', 'SpeechPropertyComplexResponseSpeed',
           'SpeechAudioFormatGUIDText', 'SAFTCCITT_ALaw_8kHzMono',
           'DISPID_SLPType', 'DISPID_SVStatus', 'SRAImport',
           'SAFT24kHz8BitStereo', 'SP_VISEME_5',
           'DISPID_SPISaveToMemory', 'SVSFPurgeBeforeSpeak',
           'SpeechTokenKeyAttributes', 'eLEXTYPE_USER',
           ...
           'DISPID_SPAsCount', 'ISpPhoneConverter',
           'SPWAVEFORMATTYPE', 'DISPID_SPPId', 'ISpLexicon',
           'SPLOADOPTIONS', 'DISPID_SVEViseme',
           'DISPID_SRCESoundStart', 'DISPID_SRAudioInputStream',
           'ISpeechTextSelectionInformation',
           'DISPID_SpeechPhraseInfo', 'DISPID_SLWsCount',
           'DISPID_SGRsItem', 'DISPID_SRGSetWordSequenceData',
           'SpeechRuleAttributes', 'DISPID_SRCreateRecoContext',
           'SpeechTokenContext', 'SAFT12kHz16BitStereo',
           'SpeechRecoProfileProperties',
           'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
           'ISpeechPhraseElements', 'SBONone',
           ...
           'SRATopLevel', 'UINT_PTR', 'SPADAPTATIONRELEVANCE',
           'DISPID_SRCERecognition', 'SpeechPartOfSpeech',
           'SpeechWordType', 'DISPID_SMSSetData',
           'DISPID_SRCEPropertyStringChange', 'SpeechRecognitionType',
           'SpStream', 'SPPS_Unknown', 'DISPID_SOTMatchesAttributes',
           'SPSHORTCUTPAIR', 'DISPID_SMSALineId',
           'DISPID_SRGCmdSetRuleIdState', 'SpeechAudioFormatType',
           'SAFTCCITT_ALaw_11kHzMono',
           'DISPID_SRCERecognitionForOtherContext',
           'SPEI_RECOGNITION', 'DISPID_SVEVoiceChange',
           'SGRSTTDictation', 'ISpPhraseAlt', 'DISPID_SRCESoundEnd',
           'SPSFunction', 'SGDSActive', 'SPGS_DISABLED',
           'SpeechVoiceEvents', 'SAFT44kHz16BitStereo',
           'SpeechGrammarTagUnlimitedDictation',
           'DISPID_SRGetPropertyString', 'DISPID_SRGDictationLoad',
           'STCAll', 'SPWORDLIST', 'SRSInactive',
           'DISPID_SRGCmdSetRuleState', 'SPEI_START_SR_STREAM',
           'SVSFlagsAsync', 'DISPID_SRCEInterference',
           'DISPID_SVAlertBoundary', 'DISPID_SRGSetTextSelection',
           'DISPID_SOTCId', 'SPWORDPRONUNCIATION', 'SRERequestUI',
           'SITooQuiet', 'SPEI_PROPERTY_NUM_CHANGE', 'SpVoice',
           'DISPID_SpeechMemoryStream', 'SpeechWordPronounceable',
           'DISPID_SpeechVoiceStatus', 'ISpeechRecognizerStatus',
           'SRAExport', 'DISPID_SOTIsUISupported',
           'SPEI_END_SR_STREAM', 'ISpeechRecoResultDispatch',
           'SPEI_SOUND_END', 'DISPID_SPRuleChildren',
           'SREStreamStart', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
           'SPGRAMMARSTATE', 'SpPhraseInfoBuilder', 'SPAS_CLOSED',
           'SPINTERFERENCE_LATENCY_TRUNCATE_END',
           'DISPID_SPCPhoneToId', 'DISPID_SCSBaseStream',
           'eLEXTYPE_MORPHOLOGY', 'ISpeechAudio',
           'DISPID_SPPNumberOfElements', 'SVEAudioLevel',
           'DISPID_SpeechPhraseRule', 'SPEI_RESERVED5',
           'DISPID_SPIGetText', 'SPCS_ENABLED', 'SAFT48kHz8BitStereo',
           'DISPID_SGRAddResource', 'SPWF_SRENGINE', 'SGDSInactive',
           'SWPUnknownWordUnpronounceable', 'DISPID_SpeechAudio',
           'SPWORDTYPE', 'DISPID_SpeechPhraseRules', 'SLODynamic',
           'DISPID_SGRSTsItem', 'ISpObjectWithToken',
           'DISPID_SLPPartOfSpeech', 'SPINTERFERENCE_TOOSLOW',
           'SAFT12kHz8BitStereo', 'ISpShortcut', 'SAFT8kHz16BitMono',
           'SpeechStreamFileMode', 'DISPID_SPEEngineConfidence',
           '__MIDL_IWinTypes_0009', 'ISpeechMMSysAudio',
           'SpeechRegistryUserRoot', 'SPSInterjection',
           'ISpeechPhraseRules', 'SDKLCurrentConfig', 'SpObjectToken',
           'DISPID_SDKGetlongValue', 'ISpeechAudioFormat',
           'SpeechPropertyResponseSpeed',
           'DISPID_SpeechRecoContextEvents', 'SVP_9', 'SVP_8',
           'DISPID_SpeechGrammarRuleStateTransition',
           'SPINTERFERENCE', 'SVP_5', 'SVP_4', 'SVP_7', 'SVP_6',
           'SVP_1', 'DISPID_SPRuleName', 'SVP_3', 'SVP_2',
           'DISPID_SLWPronunciations', 'DISPID_SVEStreamEnd',
           'DISPID_SPEPronunciation', 'DISPID_SpeechAudioStatus',
           'DISPID_SBSFormat', 'ISpNotifySink', 'DISPID_SGRsCommit',
           'SPPS_RESERVED4', 'DISPID_SVSpeakCompleteEvent',
           'SAFTExtendedAudioFormat', 'SPPS_RESERVED1',
           'DISPID_SPPBRestorePhraseFromMemory', 'SPPS_RESERVED3',
           'SPPS_RESERVED2', 'SGRSTTRule', 'DISPID_SpeechObjectToken',
           'DISPID_SPCLangId', 'SAFT22kHz8BitMono',
           'SSFMOpenReadWrite', 'DISPID_SWFEAvgBytesPerSec',
           'SPSVerb', 'SPRULESTATE', 'DISPID_SPACommit',
           'SPTEXTSELECTIONINFO', 'SPINTERFERENCE_NOISE',
           'DISPID_SRRTTickCount', 'SPEVENTSOURCEINFO',
           'SPCATEGORYTYPE', 'SVSFIsFilename',
           'SAFTCCITT_uLaw_11kHzStereo', 'SRADefaultToActive',
           'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPCIdToPhone',
           'DISPID_SAFSetWaveFormatEx', 'DISPID_SVIsUISupported',
           'SPAS_PAUSE', 'SREAdaptation',
           'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SAFGuid',
           'SPWORDPRONUNCIATIONLIST', 'SVEPrivate',
           'DISPID_SLPsCount', 'DISPID_SPIGrammarId',
           'DISPID_SPRsItem', 'ISpRecoGrammar2',
           'DISPID_SpeechPhoneConverter', 'SVP_19', 'SPPARTOFSPEECH',
           'SPAUDIOSTATUS', 'ISpeechRecoResultTimes', 'SVP_15',
           'SVP_14', 'SVP_17', 'SVP_16', 'SVP_11', 'SVP_10', 'SVP_13',
           'SVP_12', 'DISPID_SRRDiscardResultInfo',
           'DISPID_SGRAttributes', 'SAFTADPCM_8kHzMono',
           'DISPID_SLGetPronunciations', 'DISPID_SRCVoicePurgeEvent',
           'SpAudioFormat', 'DISPID_SRCBookmark',
           'SAFTADPCM_44kHzStereo', 'SREFalseRecognition',
           'DISPID_SDKSetLongValue', 'SpeechRecognizerState',
           'ISpeechObjectTokenCategory', 'SECNormalConfidence',
           'SRSActiveAlways', 'SVF_None', 'ISpRecognizer3',
           'SPEI_SENTENCE_BOUNDARY', 'SPEI_SR_AUDIO_LEVEL',
           'SAFTDefault', 'SECLowConfidence', 'ISpRecoContext2',
           'SAFTADPCM_8kHzStereo', 'SAFT48kHz16BitStereo',
           'DISPID_SGRsDynamic', 'DISPID_SOTDataKey',
           'SPAO_RETAIN_AUDIO', 'SAFTGSM610_11kHzMono',
           'ISpeechGrammarRules', 'DISPID_SADefaultFormat',
           'SAFT8kHz8BitStereo', 'SPCT_COMMAND', 'SPPS_Verb',
           'DISPID_SASNonBlockingIO', 'SPAUDIOBUFFERINFO',
           'DISPID_SOTCreateInstance', 'SVP_0',
           'SpeechRetainedAudioOptions', 'SPRECOGNIZERSTATUS',
           'SDTAlternates', 'DISPID_SpeechPhraseAlternates',
           'SWTAdded', 'SpeechDataKeyLocation', 'SPBOOKMARKOPTIONS',
           'ISpeechRecognizer', 'SPEI_MIN_TTS', 'DISPID_SAFType',
           'DISPID_SRGetPropertyNumber',
           'DISPIDSPTSI_SelectionOffset',
           'DISPID_SRGCmdLoadFromProprietaryGrammar',
           'SVSFParseAutodetect', 'SPEI_MIN_SR', 'SPRECORESULTTIMES',
           'DISPID_SpeechPhraseProperties', 'SVSFParseSapi',
           'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCCreateGrammar',
           'SPXRO_Alternates_SML', 'SGRSTTEpsilon',
           'DISPID_SRCResume', 'DISPID_SVEWord',
           'ISpeechGrammarRuleStateTransitions', 'SVP_18',
           'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRuleConfidence',
           'SpeechAllElements', 'DISPID_SFSOpen', 'SDTAudio',
           'DISPID_SPRuleParent', 'SGRSTTWord',
           'SpeechDictationTopicSpelling',
           'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
           'DISPID_SPPEngineConfidence', 'DISPID_SVGetVoices',
           'SPEI_UNDEFINED', 'SPSERIALIZEDRESULT',
           'ISpeechPhraseProperty', 'DISPID_SPEsItem',
           'DISPID_SPIRetainedSizeBytes', 'ISpeechPhraseRule',
           'DISPID_SpeechRecoResultTimes', 'DISPID_SRRAudioFormat',
           'DISPID_SABIEventBias', 'SGDisplay',
           'Speech_StreamPos_RealTime', 'DISPID_SRRSetTextFeedback',
           'SPSMF_SRGS_SAPIPROPERTIES', 'SINoise', 'SP_VISEME_21',
           'SVESentenceBoundary', 'ISpeechXMLRecoResult',
           'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SDKDeleteKey',
           'DISPID_SRGState', 'DISPID_SRCERecognizerStateChange',
           'DISPID_SpeechLexiconWords', 'DISPID_SRGId',
           'SAFTADPCM_11kHzMono', 'SECFNoSpecialChars',
           'DISPID_SLWWord', 'SPINTERFERENCE_TOOFAST', 'SGLexical',
           'SpeechVoiceSkipTypeSentence', 'DISPID_SPIEngineId',
           'DISPID_SOTsCount', 'DISPID_SRCEStartStream',
           'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_USER_SHORTCUT',
           'SpSharedRecognizer', 'SREHypothesis',
           'DISPID_SRCEHypothesis', 'DISPID_SGRSAddRuleTransition',
           'SDTPronunciation', 'DISPID_SpeechRecoContext',
           'SpMMAudioOut', 'SAFT16kHz8BitMono', 'SPPS_Noun',
           'DISPID_SGRSAddSpecialTransition',
           'SpeechCategoryRecognizers', 'STCInprocServer',
           'SPAR_Unknown', 'DISPID_SPEAudioSizeBytes',
           'SpeechEmulationCompareFlags', 'DISPID_SpeechLexicon',
           'DISPID_SGRSTsCount', 'SPBO_TIME_UNITS',
           ...
           'DISPID_SRSetPropertyNumber', 'SPEI_TTS_AUDIO_LEVEL',
           'ISpSerializeState', 'DISPID_SVSPhonemeId',
           'DISPID_SOTCDefault', 'SpeechCategoryAudioIn',
           'DISPID_SBSRead', 'ISpPhoneticAlphabetConverter',
           'SAFT24kHz16BitStereo', 'ISpeechLexicon',
           'DISPID_SpeechWaveFormatEx', 'SVEWordBoundary',
           'DISPIDSPTSI_SelectionLength', 'SDTReplacement',
           'ISpeechDataKey', 'SRAInterpreter',
           'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_PRIVATE11',
           'eLEXTYPE_PRIVATE10', 'eLEXTYPE_PRIVATE13',
           'eLEXTYPE_PRIVATE12', 'eLEXTYPE_PRIVATE15',
           'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE17',
           'eLEXTYPE_PRIVATE16', 'eLEXTYPE_PRIVATE19',
           'eLEXTYPE_PRIVATE18', '_ISpeechRecoContextEvents',
           'SBOPause', 'SPSEMANTICERRORINFO',
           'ISpeechGrammarRuleStateTransition', 'SPRULE',
           'SAFT44kHz8BitMono', 'SRERecoOtherContext',
           'SpeechTokenValueCLSID', 'SPEVENTENUM', 'SVSFDefault',
           'DISPID_SPAsItem', 'SGSEnabled', 'DISPID_SpeechVoice',
           'SPVOICESTATUS', 'SPEI_FALSE_RECOGNITION',
           'DISPID_SDKSetStringValue', 'SPSMF_SAPI_PROPERTIES',
           'SPVPRI_ALERT', 'SAFT22kHz16BitStereo',
           'ISpeechFileStream', 'SPPHRASERULE', 'SPVISEMES',
           'DISPID_SGRSRule', 'eLEXTYPE_RESERVED9',
           'eLEXTYPE_RESERVED8', 'STSF_FlagCreate',
           'ISpeechRecoContext', 'DISPID_SVGetAudioInputs',
           'eLEXTYPE_RESERVED7', 'eLEXTYPE_RESERVED6',
           'DISPID_SPRuleFirstElement', 'eLEXTYPE_RESERVED4']
from comtypes import _check_version; _check_version('', 1596991515.014537)
