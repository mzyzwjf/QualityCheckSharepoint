# -*- coding: mbcs -*-
typelib_path = u'C:\\Users\\Administrator\\AppData\\Local\\Kingsoft\\WPS Office\\11.1.0.10069\\office6\\vbe6ext.olb'
...
VBE._methods_ = [
    ...
    COMMETHOD([dispid(108), 'propget'], HRESULT, 'CommandBars',
              ( ['retval', 'out'], POINTER(POINTER(comtypes.gen._2DF8D04C_5BFA_101B_BDE5_00AA0044DE52_0_99_1.CommandBars)), 'ppcbs' )),
...
__all__ = [ 'CodePanes', 'vbextFileTypeRes', '_VBProject',
           '_VBProjects', '_dispVBComponentsEvents', '_VBComponent',
           'LinkedWindows', 'vbext_wt_PropertyWindow',
           'vbext_VBAMode', 'vbext_WindowState', 'CommandBarEvents',
           '_Component', 'vbext_CodePaneview', 'vbext_wt_Browser',
           '_Windows_old', 'AddIn', '_VBComponent_Old',
           '_VBComponents_Old', '_CommandBarControlEvents',
           ...
           'vbext_rk_TypeLib', 'vbext_wt_MainWindow', 'vbext_pk_Set',
           'vbext_wt_Locals', 'vbext_ct_MSForm', 'vbext_ProjectType',
           '_Windows', 'vbext_pk_Get', '_Components',
           '_dispVBProjectsEvents', 'vbext_pp_locked', 'Property',
           '_VBProjects_Old', 'vbext_wt_Immediate',
           'vbext_ct_StdModule', 'VBComponent', 'vbext_wt_Designer',
           'vbext_wt_LinkedWindowFrame', 'vbext_vm_Run',
           '_ProjectTemplate', 'vbext_wt_Find', '_ReferencesEvents',
           'vbext_wt_Toolbox', 'VBE', '_CodeModule',
           'vbext_cv_ProcedureView', 'Events', 'VBProject',
           'vbext_pt_HostProject', 'vbextFileTypeGroupProject',
           'vbextFileTypeClass', '_VBComponents', 'vbext_ws_Normal',
           'vbextFileTypeExe', 'ReferencesEvents',
           'vbext_ct_ActiveXDesigner', '_dispReferences_Events',
           'vbextFileTypeForm', 'Properties', 'vbext_ws_Minimize',
           'vbext_wt_ToolWindow', '_CodePanes', 'vbext_vm_Break',
           '_Properties', 'vbextFileTypeFrx', 'CodePane',
           'vbext_cv_FullModuleView', 'vbext_ct_ClassModule',
           '_References', 'vbext_pk_Proc', 'Window', 'vbext_wt_Watch',
           'References', 'vbextFileTypePropertyPage',
           '_LinkedWindows', 'vbext_rk_Project', 'VBProjects',
           '_VBComponentsEvents', 'vbext_pp_none', 'ProjectTemplate',
           '_AddIns', 'VBComponents', 'vbext_pk_Let',
           'vbext_ws_Maximize', 'vbextFileTypeModule',
           'vbext_wt_ProjectWindow', 'Component',
           'vbextFileTypeDocObject', 'vbext_wt_CodeWindow',
           '_VBProject_Old', 'Windows', 'vbext_pt_StandAlone',
           'vbextFileTypes', 'vbextFileTypeUserControl',
           'vbextFileTypeDesigners', '_CodePane',
           '_dispReferencesEvents', 'vbext_vm_Design']
from comtypes import _check_version; _check_version('', 1596909988.554081)
